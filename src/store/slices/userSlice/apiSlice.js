...
export const { useLoginMutation, useGetUserQuery, useGetUserInfoQuery, useUpdateUserInfoMutation, useUpdateUserVerificationMutation, useGetUsersQuery, useGetUserDevicesQuery, } = adminAuthApi;
