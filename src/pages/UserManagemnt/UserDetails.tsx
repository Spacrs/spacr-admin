...
// import {useUpdateUserInfoMutation} from '../../store/slices/userSlice/apiSlice'
...
//               <select
//                 id="status"
//                 value={status} onChange={handleOnChange}
...
const UserDetails = () => {
  ...
  useEffect(() => {
    if (data?.data) {
      setStatus(data?.data.Status); // Initialize the dropdown with the current status of the user
    }
  }, [data]);
