...
function CostList() {
    ...
    //   }
    // };
    const { data, isLoading, isError, } = useGetCostsListQuery({
        page: currentPage,
        limit: itemsPerPage,
        search: filter,
    });
