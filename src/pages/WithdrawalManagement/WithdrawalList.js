...
export default function WithdrawalList() {
    ...
    const { data, isLoading, isFetching, refetch } = useGetWithdrawalListQuery({
        page,
        limit,
    });
    useEffect(() => {
