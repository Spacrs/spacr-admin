...
import { useUpdateOrderTrendMutation, } from "../../store/slices/orderSlice/apiSlice";
import { useAppDispatch, useAppSelector } from "../../store/hooks";
import { updateOrderList, } from "../../store/slices/orderSlice/orderSlice";
...
function InvoiceList() {
    ...
    useEffect(() => {
        if (data?.data) {
            // dispatch(
            setInvoiceList(data.data.map((order) => ({
                ...order,
