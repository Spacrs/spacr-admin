...
function OrderOffers() {
    ...
    if (isError) {
        return _jsx(ErrorMsg, { errorMsg: "Error in loading offers" });
    }
    return (_jsxs("div", { className: "", children: [_jsx("div", { className: "flex justify-end items-center mb-4 p-4 bg-gray-100 shadow-md rounded-lg", children: _jsx("div", { className: "ml-4", children: _jsx(Button, { text: "Back", className: "mr-2", variant: "lightBlue", onClick: () => navigate("/admin/order-details/" + orderId) }) }) }), _jsx("div", { className: "flex flex-col p-4 bg-gray-100 rounded-lg shadow-md sm:overflow-x-auto xs:overflow-x-auto", children: _jsx(Table, { data: offers, columns: columns, loading: isLoading || isFetching, totalPages: data?.pagination?.totalPages || 1, currentPage: currentPage, onPageChange: setCurrentPage, itemsPerPage: itemsPerPage }) })] }));
}
