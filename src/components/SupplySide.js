...
export default function SupplySide() {
    ...
    const [startDate, setStartDate] = useState(from); // subDays(new Date(), 30)
    const [endDate, setEndDate] = useState(to); // new Date()
