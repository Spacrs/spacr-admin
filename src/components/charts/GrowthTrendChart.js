...
export default function GrowthTrendChart() {
    ...
    return (_jsxs("div", { className: "bg-white rounded-xl p-5 shadow-sm border border-gray-100 space-y-4", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h2", { className: "text-base font-semibold", children: "Growth Trends" }), _jsx(DateRangePicker, { onChange: (range) => {
                            if (range.from && range.to) {
                                ...
                                return (_jsxs("div", { className: "bg-white border border-gray-200 rounded-lg shadow-md p-3 text-xs", children: [_jsxs("p", { className: "text-green-600", children: ["GMV: ", fmtCurrency(d.GMV)] }), _jsxs("p", { className: "text-orange-500", children: ["Revenue: ", fmtCurrency(d.revenue)] }), _jsxs("p", { className: "text-blue-600", children: ["Users: ", d.totalUsers] })] }));
                            } }), _jsx(Legend, { verticalAlign: "bottom", height: 36, wrapperStyle: { fontSize: 12 }, formatter: (value) => _jsx("span", { className: "text-gray-700", children: value }) }), _jsx(Bar, { yAxisId: "right", dataKey: "totalUsers", name: "Total Users", fill: "#3b82f6", barSize: 40, radius: [6, 6, 0, 0] }), _jsx(Line, { yAxisId: "left", type: "linear" // monotone
                            , dataKey: "revenue", name: "Revenue", stroke: "#f97316", strokeWidth: 2, dot: { r: 4 } }), _jsx(Line, { yAxisId: "left", type: "linear", dataKey: "GMV", name: "GMV", stroke: "#16a34a", strokeWidth: 2 })] }) }))] }));
}
