  ...
  return (
    ...
    >
      ...
      <PopoverContent align={align} className="w-auto">
        ...
        {!isSmallScreen && (
            <div className="flex flex-col gap-3 min-w-[180px] border-r border-gray-200 pl-6 pb-6 mr-4">
                <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Quick Select</div>
