import { IColumns } from "../components/Common/Table";
...
// travelListingColumn
const travelListingColumn: IColumns[] = [
...
const notificationListColumn: IColumns[] = [
...
export const cacListColumn: IColumns[] = [
  {
    name: "Month",
    Header: "Month",
    colName: "Default",
...
const invoiceListColumn: IColumns[] = [
  { name: "image", Header: "Image", colName: "Image", icon: "order" },
  {
    name: "ProductName",
    Header: "Product Name",
